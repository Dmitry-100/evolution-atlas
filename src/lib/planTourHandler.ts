...
export const PLAN_TOUR_SYSTEM_PROMPT = [
  ...
  "Для каждой остановки напиши связный narrationRu на 3-5 живых фраз, lookAtRu с явной подсказкой куда смотреть на странице и revealRu как интересный факт или заметку гида.",
