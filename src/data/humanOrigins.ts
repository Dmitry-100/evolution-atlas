...
export const HUMAN_ORIGIN_SITES: HumanOriginSite[] = [
  ...
  },
  {
    ...
    ageRu: "около 233 тыс. лет назад или старше (нижняя оценка)",
    evidenceRu: "одни из важных ранних ископаемых Homo sapiens в Восточной Африке, уточненные по вулканическому слою",
    whyMattersRu:
    ...
    confidence: "solid",
    source: {
      label: "Nature: Vidal et al. 2022 Omo I",
