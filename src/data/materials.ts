...
export const READING_RECOMMENDATIONS: ReadingRecommendation[] = [
  {
    ...
    whyReadRu:
      "Продолжает Атлас: антропогенез держится на множестве находок, а не на единственном “недостающем звене”.",
  },
  {
  ...
  },
  {
    ...
    whyReadRu:
      "Продолжает раздел РНК/ДНК: генетика — не приговор, а язык вероятностей и статистики.",
  },
  {
  ...
  },
  {
    ...
    whyReadRu:
      "Продолжение разделов о приматах и генетике: человеческая история — сеть миграций и смешений, а не прямая линия.",
  },
  {
    ...
    whyReadRu:
      "Расширяет тему наследуемой изменчивости: перемешивание генов становится материалом для отбора и эволюционных компромиссов.",
  },
  {
  ...
  },
  {
    ...
    whyReadRu:
      "Продвинутое продолжение после “Эгоистичного гена”: расширяет взгляд на то, что именно отбирается эволюцией.",
  },
  {
    ...
    whyReadRu:
      "Прямое продолжение раздела “Зарождение жизни”: снимает ощущение, что первая клетка возникла скачком.",
  },
  {
  ...
  },
  {
    ...
    whyReadRu:
      "Рядом с кладограммой объясняет, как ученые вообще строят такие деревья.",
  },
  {
    ...
    whyReadRu:
      "Вход для тех, кто хочет связать РНК/ДНК, клетки, эволюцию и дерево родства в одну картину.",
  },
  {
  ...
  },
  {
    ...
    whyReadRu:
      "Читайте рядом с разделами о приматах и Homo sapiens: здесь эволюционная идея применяется прямо к происхождению человека.",
  },
  {
    ...
    whyReadRu:
      "Выводит портал за пределы “человек и животные”: наша история связана со всей экосистемой.",
  },
];

export const MUSEUM_RECOMMENDATIONS: MuseumRecommendation[] = [
  {
    id: "darwin-museum",
    titleRu: "Государственный Дарвиновский музей",
    focusRu: "эволюция и биоразнообразие",
    href: "https://www.darwinmuseum.ru/",
    addressRu: "Москва, ул. Вавилова, 57",
    descriptionRu:
      "Крупный естественно-научный музей о происхождении видов, наследственности, отборе, разнообразии животных и связях человека с живой природой.",
    whyVisitRu:
      "Главный московский офлайн-мост к порталу: идеи эволюции тут становятся витринами, скелетами и диорамами.",
  },
  {
    id: "orlov-paleontological-museum",
    titleRu: "Палеонтологический музей им. Ю. А. Орлова",
    focusRu: "ископаемые и древо жизни",
    href: "https://www.paleo.ru/museum/",
    addressRu: "Москва, ул. Профсоюзная, 123",
    descriptionRu:
      "Музей Палеонтологического института РАН с залами по истории органического мира Земли: от древнейших организмов до динозавров и млекопитающих.",
    whyVisitRu:
      "Прямое продолжение шкалы времени и раздела про вымирания: можно увидеть реальные ископаемые формы, а не только читать о переходах между эпохами.",
  },
  {
    id: "timiryazev-biological-museum",
    titleRu: "Биологический музей им. К. А. Тимирязева",
    focusRu: "живая природа и признаки жизни",
    href: "https://gbmt.ru/ru/",
    addressRu: "Москва, ул. Малая Грузинская, 15",
    descriptionRu:
      "Биомузей показывает живые системы на разных уровнях: растения, животных, человека, экологию, микромир и признаки, по которым мы узнаем живое.",
    whyVisitRu:
      "Хорошее место после страниц про РНК/ДНК и происхождение жизни: помогает переключиться с большой эволюционной истории на устройство живых систем.",
  },
  {
    id: "msu-zoological-museum",
    titleRu: "Зоологический музей МГУ",
    focusRu: "сравнительная анатомия",
    href: "https://zmmu.msu.ru/",
    addressRu: "Москва, ул. Большая Никитская, 2",
    descriptionRu:
      "Классический университетский музей о разнообразии животных: беспозвоночные, рыбы, амфибии, рептилии, птицы, млекопитающие и сравнительная анатомия.",
    whyVisitRu:
      "Полезен рядом с кладограммой: музей буквально тренирует взгляд на родство, различия планов строения и повторяющиеся решения эволюции.",
  },
  {
    id: "vernadsky-geological-museum",
    titleRu: "Геологический музей им. В. И. Вернадского",
    focusRu: "геология и история Земли",
    href: "https://sgm.ru/",
    addressRu: "Москва, ул. Моховая, 11, стр. 11",
    descriptionRu:
      "Геологический музей РАН о породах, минералах, недрах и истории Земли — полезный контекст для климата, океанов, материков и среды эволюции.",
    whyVisitRu:
      "Не про биологию напрямую, но хорошо объясняет сцену, на которой развивается жизнь: геологическое время, катастрофы, ресурсы и смену условий среды.",
  },
];
...
export const WATCH_RECOMMENDATIONS: WatchRecommendation[] = [
  {
    ...
    whyWatchRu:
      "Не учебник, а визуальный опыт — эмоциональное продолжение идей Атласа.",
  },
  {
    ...
    whyWatchRu:
      "Видео-дополнение к разделам “Зарождение жизни” и “РНК/ДНК”: показывает, как химия Земли превращается в биологию.",
  },
  {
