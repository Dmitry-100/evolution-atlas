...
export const MUSEUM_RECOMMENDATIONS: MuseumRecommendation[] = [
  {
    ...
    whyVisitRu:
      "Лучший московский офлайн-мост к порталу: здесь абстрактные идеи эволюции превращаются в витрины, скелеты, диорамы и понятные семейные маршруты.",
  },
  {
    ...
    whyVisitRu:
      "Самое прямое продолжение шкалы времени и раздела про вымирания: можно увидеть реальные ископаемые формы, а не только читать о переходах между эпохами.",
  },
  {
