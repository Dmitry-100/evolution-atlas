...
export const QUIZ_TOPICS: Record<QuizTopicId, QuizTopic> = {
  ...
  "deep-time": {
    ...
    practiceRu: "Почувствуйте масштаб ещё раз: почти всё важное для человека умещается в самом конце шкалы.",
    links: [
  ...
  "human-lineage": {
    ...
    links: [
      { labelRu: "Приматы и человек", href: "/primates" },
...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  question(
    ...
    "Конечность не возникает с нуля. Эволюция перестраивает то, что уже было в плавнике: кости, опору, мышцы.",
    [
  ...
  question(
    ...
    "Скорее это близкая боковая ветвь людей. Homo sapiens частично с ними смешивался, но это не лестница 'ниже-выше'.",
    [
  ...
  question(
    ...
    "У хордовых появляется опорная ось и нервная трубка — то, на чём позже выстроится скелет позвоночных.",
    [
  ...
  question(
    ...
    "Ветвь позвоночных с конечностями и пальцами. От неё пошли амфибии, рептилии, птицы и млекопитающие.",
    [
  ...
  question(
    ...
    "В эту ветвь приматов входят обезьяны, человекообразные и люди.",
    [
  ...
  question(
    ...
    "Боковая ветвь антропоидов. Помогает понять родство обезьян, но прямым предком человека не была.",
    [
  ...
  question(
    ...
    "Ветвь, которая после расхождения с линией шимпанзе ведёт к человеку. Сюда входят австралопитеки и род Homo.",
    [
  ...
  question(
    ...
    "Дарвин объяснил эволюционные изменения через естественный отбор и общее происхождение видов.",
    [
  ...
  question(
    ...
    "Перья появились до полноценного полета. Они могли сохранять тепло и служить для демонстраций.",
    [
  ...
  question(
    ...
    "Почти все организмы читают кодоны одинаково. Это похоже на наследство от общего предка.",
    [
  ...
  question(
    ...
    "LUCA — не первая жизнь и не единственный предок-родоначальник, а реконструированный последний общий предок всех нынешних клеточных линий.",
    [
  ...
  question(
    ...
    "Сильны не общие проценты похожести, а следы редких событий, которые можно сравнивать между родственными линиями.",
    [
