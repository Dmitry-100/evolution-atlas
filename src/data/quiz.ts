...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  question(
    ...
    "Если считать от примерно 4 млрд лет истории жизни, к моменту ранних приматов прошло около 98,4% этого пути.",
    [
      ["small", "Примерно 10%"],
      ["half", "Около половины"],
  ...
  question(
    "placentals",
    "Почему плацентарные важны для нашей ветви?",
    "Человек относится к плацентарным млекопитающим: развитие плода связано с плацентой, а эта группа позже дала много современных линий.",
    [
      ["placenta", "Это группа млекопитающих с плацентарным развитием", true],
  ...
  question(
    ...
    "Какие признаки помогают узнать ранних приматов?",
    "Для приматной линии важны хватательные конечности, зрение вперед и жизнь, связанная с ветвями и сложной ориентацией.",
    [
      ["grasping-vision", "Хватательные конечности и зрение вперед", true],
  ...
  question(
    ...
    "Кладограмма показывает ветвление родства: где идет ствол нашей линии и где отходят боковые ветви.",
    [
