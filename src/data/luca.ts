...
export const LUCA_TREE_NODES: LucaTreeNode[] = [
    ...
    bodyRu:
      "Реконструкция LUCA помогает объяснить, почему у бактерий, архей и эукариот остается общий молекулярный каркас; сама схема ниже использует современную двухдоменную рамку.",
  ...
  },
  {
    ...
    bodyRu:
      "Археи важны для понимания ранней жизни: они глубоко отличаются от бактерий, а современные деревья помещают происхождение эукариот внутрь архейной области.",
  ...
  },
  {
    ...
    bodyRu:
      "Эукариоты объединяют животных, растения, грибы и множество одноклеточных; эта поздняя сложная ветвь возникла в архейном контексте и получила митохондрии через эндосимбиоз.",
