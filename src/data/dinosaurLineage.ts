...
export const birdDinosaurBranch: DinosaurLineageStage[] = [
  ...
  },
  {
    ...
    whyMattersRu: "Птицы возникли в одной из ветвей динозавров. Птичьи признаки накапливались постепенно у разных линий.",
...
export const dinosaurCommonAncestor = {
  ...
  humanBranchRu: "синапсиды, затем терапсиды, цинодонты, млекопитающие, приматы и человек",
  dinosaurBranchRu: "диапсиды, затем архозавры, динозавры, тероподы и птицы",
