...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    exampleRu: "Антропоиды — это уже не все приматы, а ветвь, где усиливаются зрение и социальность.",
  },
  {
    id: "hominins",
    titleRu: "Гоминины",
    ...
    exampleRu: "Гоминины — это не все человекообразные, а наша более узкая ветвь.",
  },
  {
    id: "cladogram",
    titleRu: "Кладограмма",
