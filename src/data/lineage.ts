...
export const STAGES: EvolutionStage[] = [
  {
    ...
    summaryRu: "Самые ранние устойчивые формы жизни были клеточными линиями, задолго до животных, растений и нервной системы.",
    whyMattersRu: "Здесь начинается наследование: клетки копируют информацию, отделяют себя мембраной и создают основу для всей дальнейшей эволюции.",
    ...
    sources: [visualCapitalist, wiki("Protocell", "Protocell")],
  },
  {
    id: "prokaryotes",
    slug: "prokaryotes",
  ...
  },
  {
    ...
    whyMattersRu: "Это исправленная точка шкалы: не 600 млн лет, а примерно кембрийская область около 535 млн лет назад.",
    ...
    sources: [wiki("Chordate", "Chordate"), wiki("Pikaia", "Pikaia")],
  },
  {
    id: "vertebrates",
    slug: "vertebrates",
  ...
  },
  {
    id: "placentals",
    slug: "placentals",
    titleRu: "Плацентарные",
    latin: "Placentalia / Eutheria",
    ageMa: 105,
    eraId: "mammals",
    lineageRole: "direct-lineage",
