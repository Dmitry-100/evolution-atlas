...
export const SOURCE_IMAGES: Record<string, SourceImageRecord> = {
  ...
  "cambrian-explosion": {
    src: "/assets/images/source-backed/generated-atlas/cambrian-explosion.png",
    sourceUrl: "https://openai.com/",
    credit: "AI-реконструкция / локальная генерация",
    license: "AI-реконструкция; визуальная иллюстрация",
    commonsTitle: "generated-atlas-cambrian-explosion",
    description:
      "AI-реконструкция разнообразной кембрийской морской фауны с трилобитами, ранними членистоногими и хищниками.",
    kind: "generated-reconstruction",
    promptId: "cambrian-explosion-paleoart-2026-06-30",
  },
