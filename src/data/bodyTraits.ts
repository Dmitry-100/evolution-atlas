...
export const BODY_TRAITS: BodyTrait[] = [
  ...
  },
  {
    ...
    noteRu:
      "В цинодонтной области родства элементы древней челюстной системы постепенно переходят к тонкому механизму среднего уха млекопитающих.",
    anchor: { x: 68, y: 38 },
    confidence: "solid",
  },
  {
  ...
  },
  {
    ...
    noteRu:
      "Символы связывают людей вокруг того, чего нет перед глазами: образов, правил, историй.",
    anchor: { x: 72, y: 58 },
    confidence: "solid",
  },
  {
