...
export const BODY_TRAITS: BodyTrait[] = [
  ...
  },
  {
    ...
    noteRu:
      "Удачные варианты теперь можно копировать, и отбор получает материал, с которым работать.",
    anchor: { x: 39, y: 55 },
    confidence: "solid",
  },
  {
  ...
  },
  {
    ...
    noteRu:
      "Это изменение среды, а не унаследованная часть тела. Кислородный фотосинтез существовал до Великого окислительного события, которое относят примерно к 2,4 млрд лет назад.",
    anchor: { x: 23, y: 46 },
    confidence: "solid",
  },
  {
  ...
  },
  {
    ...
    noteRu:
      "Лёгкие возникли у костных рыб ещё до выхода позвоночных на сушу. Карточка четвероногих показывает их роль в освоении наземной среды, а не первое появление органа.",
    anchor: { x: 58, y: 28 },
    confidence: "solid",
  },
  {
  ...
  },
  {
    ...
    noteRu:
      "По дальним косточкам плавника видно: кисть не возникла заново, её перестроили из старого.",
    anchor: { x: 28, y: 51 },
    confidence: "solid",
  },
  {
  ...
  },
  {
    ...
    noteRu:
      "Перестройку таза у самых ранних гоминин предполагают по эволюции походки. Таз сахелантропа не найден: доводы о его двуногости опираются на другие кости. Более поздние находки, включая ардипитека, позволяют изучать таз непосредственно.",
    anchor: { x: 50, y: 55 },
    confidence: "likely",
  },
  {
  ...
  },
  {
    ...
    noteRu:
      "У антропоидов зрение помогало искать пищу и ориентироваться в сложной социальной среде.",
    anchor: { x: 38, y: 35 },
    confidence: "likely",
  },
  {
  ...
  },
  {
    ...
    noteRu:
      "Каменные орудия известны по меньшей мере с 3,3 млн лет назад, до находки раннего Homo возрастом 2,8 млн лет. Кто изготовил древнейшие орудия Ломекви, неизвестно.",
    anchor: { x: 24, y: 55 },
    confidence: "solid",
  },
  {
  ...
  },
  {
    ...
    noteRu:
      "Забота внутри группы — не украшение, а условие выживания.",
    anchor: { x: 60, y: 75 },
    confidence: "likely",
  },
  {
    ...
    titleRu: "Язык",
    noteRu:
      "Язык позволяет Homo sapiens передавать опыт и накапливать культуру. Время его возникновения неизвестно; отметка 300 тыс. лет относится к ранним представителям вида.",
    anchor: { x: 61, y: 42 },
    confidence: "solid",
  },
  {
    ...
    noteRu:
      "Символическое поведение Homo sapiens подтверждается археологией. Украшения, изображения и другие свидетельства датируются отдельно: возраст вида около 300 тыс. лет не задаёт дату появления всего комплекса.",
    anchor: { x: 72, y: 58 },
    confidence: "solid",
  },
  {
