...
export const CURIOSITY_FACTS: CuriosityFact[] = [
  {
    ...
    detailRu:
      "Кислородный фотосинтез постепенно насытил океаны и атмосферу кислородом. Этот сдвиг называют кислородной катастрофой. Для многих древних анаэробных систем кислород был токсичен, а будущим сложным организмам позволил получать больше энергии.",
  ...
  },
  {
    ...
    shortRu: "В эволюции сложной клетки конкуренция соседствовала с древним симбиозом.",
    detailRu:
      "Эндосимбиоз - это союз клеток, при котором одна поселилась внутри другой. Так бактериальные партнеры ранних сложных клеток стали митохондриями.",
  ...
  },
  {
    ...
    detailRu:
      "В человеческой хромосоме 2 обнаруживают признаки, ожидаемые при слиянии двух предковых хромосом. Это молекулярная метка после расхождения ветвей.",
  ...
  },
  {
    ...
    shortRu: "Сначала они могли греть, подавать сигналы и участвовать в поведении; крыло стало одной из поздних ролей.",
    detailRu:
  ...
  },
  {
    ...
    titleRu: "300 тысяч лет — крошечный хвост шкалы",
    shortRu: "На суточной модели истории жизни возраст Homo sapiens занимает примерно последние 6–7 секунд.",
    detailRu:
      "Этот пересчет полезен не точностью до секунды, а сменой масштаба: микробы, океаны, растения, животные и почти все эволюционные развилки появились задолго до нашей ветви.",
