...
export const CURIOSITY_FACTS: CuriosityFact[] = [
  ...
  },
  {
    ...
    detailRu:
      "Эндосимбиотическая теория объясняет происхождение митохондрий от бактериальных партнеров внутри ранних эукариотических клеток. Это один из самых мощных поворотов в истории сложности.",
  ...
  },
  {
    ...
    detailRu:
      "Эволюция часто перестраивает старые детали под новые функции. В линии млекопитающих изменения челюсти и слуховых косточек помогают увидеть этот принцип особенно наглядно.",
