...
export const MASS_EXTINCTIONS: MassExtinctionEvent[] = [
  ...
  },
  {
    ...
    lossPercentRu: "примерно 70-80% видов",
  ...
  },
  {
    ...
    lossPercentRu: "до 90-96% морских видов",
    snapshotRu: "Сибирские траппы выбросили колоссальные объемы CO2 и SO2; океаны нагрелись, закислились и потеряли кислород.",
    keyFactsRu: [
      "Это “Великое вымирание”: по презентации, до 90-96% морских видов могли исчезнуть в ходе пермского кризиса.",
  ...
  },
  {
    ...
    lossPercentRu: "около 70-75% видов",
