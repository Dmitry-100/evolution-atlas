...
export const MASS_EXTINCTIONS: MassExtinctionEvent[] = [
  ...
  },
  {
    ...
    tempoRu:
      "самый растянутый пример: несколько волн примерно между 372 и 359 млн лет назад, а не единичная катастрофа.",
    keyFactsRu: [
  ...
  },
  {
    ...
    keyFactsRu: [
      ...
      "Причиной стал каскад: вулканизм, парниковый перегрев, закисление, аноксия и разрушение пищевых сетей.",
    ...
    afterRu:
      "Выжившие линии заняли освободившиеся экологические роли. Мир перестроился заново.",
    relationRu:
      "Синапсидная линия прошла через этот кризис задолго до появления настоящих млекопитающих.",
    sources: [
      source(
  ...
  },
  {
    ...
    tempoRu:
      "по меркам геологии быстрый рубеж: кризис связывают с пульсами вулканизма и климатического стресса.",
    keyFactsRu: [
      ...
      "Иногда успех ветви начинается не с господства, а просто с того, что она уцелела.",
    ],
    image: {
    ...
    relationRu:
      "Для нашей линии важен сам факт сохранения: ранние млекопитающие уцелели, хотя не стали главными сразу.",
    sources: [
      source(
        "NPS: Mass extinctions through geologic time",
        "https://www.nps.gov/subjects/fossils/mass-extinctions-through-geologic-time.htm",
  ...
  },
  {
    ...
    keyFactsRu: [
      "Во время кризиса исчезли нептичьи динозавры, морские рептилии, аммониты и часть планктона. Наземные экосистемы тоже пострадали.",
  ...
  },
  {
    ...
    windowRu: "сейчас",
    lossRu:
      "Здесь нет одного удара астероида: популяции и виды ускоренно исчезают под давлением человека.",
    lossPercentRu:
    ...
    keyFactsRu: [
      ...
      "Это не “конец жизни”, но сигнал серьёзный: разнообразие может резко упасть за исторически короткий срок.",
    ],
    image: {
    ...
    relationRu:
      "Наша ветвь стала геологической силой. Homo sapiens проходит через кризис, сам его усиливает и может ослабить.",
    sources: [
      source(
