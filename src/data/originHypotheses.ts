...
export const ORIGIN_HYPOTHESES: OriginHypothesis[] = [
  ...
  },
  {
    ...
    mechanismRu:
      "Жирные кислоты самособираются в пузырьки, могут расти, делиться и удерживать молекулы внутри. Так могла выглядеть ранняя оболочка клетки.",
    evidenceRu:
  ...
  },
  {
    ...
    titleRu: "Панспермия",
    shortRu:
      "Органика и даже микробы могли попасть на Землю из космоса.",
    mechanismRu:
