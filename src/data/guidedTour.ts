...
export const GUIDED_TOUR_INTENTS: TourIntentOption[] = [
  {
    ...
    darwinPromptRu:
      "Покажу главные двери портала: атлас, доказательства, происхождение жизни, дерево родства, кризисы, динозавров и проверку себя.",
  },
  {
    id: "skeptical",
    labelRu: "Разобраться, почему эволюция - не просто мнение",
    darwinPromptRu:
      "Начнем спокойно: что ученые называют теорией, какие факты ее держат и где честные границы уверенности.",
  },
  {
    id: "ancestors",
    labelRu: "Пройти путь к человеку: кто были наши предки",
    darwinPromptRu:
      "Пойдем по ветвящейся родословной: от ранней жизни к приматам и нашему виду.",
  },
  {
    id: "child",
  ...
  },
  {
    ...
    darwinPromptRu:
      "Начнем с самой трудной двери: как химия стала наследованием, клетками и дальнейшей эволюцией.",
  },
  {
    id: "dinosaurs",
    labelRu: "Узнать, почему динозавры не совсем исчезли",
    darwinPromptRu:
      "Пойдем через динозавров, птиц и кризис на границе мела и палеогена: исчезновение здесь оказывается не таким простым.",
  },
  {
    id: "presenter",
  ...
  },
  {
    ...
    darwinPromptRu:
      "Отлично, я не буду вести за руку. Дам несколько дверей, а дальше вы идете сами.",
  },
  {
    id: "custom",
...
const PAGE_STOPS: TourStop[] = [
  {
    ...
    hintRu:
      "Поздняя ветвь маршрута: приматы, человекообразные, гоминины, Homo и карта раннего расселения нашего вида.",
    href: "/primates",
  },
  {
    id: "page-theory",
  ...
  },
  {
    ...
    hintRu:
      "Некоторые сценарии начинают не с копии молекулы, а с устойчивых сетей реакций.",
    href: "/origin-of-life",
  },
  {
  ...
  },
  {
    ...
    titleRu: "РНК/ДНК",
    hintRu:
      "Молекулярные доказательства родства: ДНК, общие маркеры и осторожность в процентах сходства.",
    href: "/genetics",
  },
  {
    id: "page-cladogram",
    ...
    hintRu:
      "Ветвящееся дерево показывает родство лучше, чем привычная лестница прогресса.",
    href: "/cladogram",
  },
  {
    id: "page-body-map",
  ...
  },
  {
    ...
    titleRu: "О проекте",
    hintRu:
      "Здесь объясняется, зачем портал показывает дерево родства вместо привычной лестницы к человеку.",
    href: "/about",
  },
  {
    id: "page-sources",
...
export const GUIDED_TOUR_BROWSE_LINKS: BrowseLink[] = [
  ...
  },
  {
    ...
    href: "/cladogram",
    descriptionRu:
      "Хороший вход, если хочется увидеть ветвление, а не линейную лестницу.",
  },
  {
