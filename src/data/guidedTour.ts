...
export const GUIDED_TOUR_INTENTS: TourIntentOption[] = [
  ...
  {
    id: "skeptical",
    labelRu: "Разобраться, чем научная теория отличается от мнения",
    darwinPromptRu:
  ...
  },
  {
    ...
    darwinPromptRu:
      "Соберем маршрут, по которому вы сами разберетесь в теме и сможете объяснить ее другим. В маршруте будут порядок показа, материалы и ссылки на источники.",
  },
  {
    id: "browse",
...
const PAGE_STOPS: TourStop[] = [
  ...
  },
  {
    ...
    hintRu:
      "Книги, музеи и видео помогают продолжить маршрут после экскурсии или собрать объяснение для другой аудитории.",
    href: "/materials",
  },
  {
    id: "page-about",
  ...
  },
  {
    ...
    titleRu: "Источники",
    hintRu:
      "Ссылки, лицензии и научная база позволяют проверить изображения и утверждения портала.",
    href: "/sources",
  },
];
