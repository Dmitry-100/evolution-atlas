  ...
  return (
    <section className="document-page">
      <div className="document-header">
        ...
        <p>
          В текущей версии каждая точка шкалы использует локально сохраненное изображение, привязанное к открытому
          источнику. Метаданные, кредиты и лицензии хранятся в одном датасете вместе с этапами.
        </p>
      </div>
