    ...
    >
      ...
      <section className="theory-bridge-band atlas-note-band">
        <div>
          ...
          <div>
            <h2>Молекулярно-генетические доказательства эволюции</h2>
            <p>
              Общий код, сходство последовательностей и редкие метки в одних и
              тех же местах генома независимо проверяют общее происхождение.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="genetics-section-heading">
          ...
          <div>
            ...
            <h2 id="genome-comparison-title">Насколько похожа ДНК человека и шимпанзе?</h2>
            <p>
      ...
      <CuriosityFacts
        ...
        description="Некоторые следы родства видны по редким меткам: симбиозу, слияниям хромосом и наследуемым вирусным вставкам."
