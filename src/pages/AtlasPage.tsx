    ...
    return (
      ...
      >
        ...
        <MobileAtlas
          ...
          description="Двигайтесь по хронологии жизни на Земле и раскрывайте ключевые этапы прямо внутри карты."
    ...
    >
      ...
      <section className="atlas-hero">
        ...
        <div className="atlas-title">
          ...
          <p>
            Проследите ключевые этапы эволюции жизни на Земле: от древних
