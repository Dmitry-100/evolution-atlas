      ...
      <article className="theory-principle darwin-note">
        ...
        <div>
          ...
          <p>
            ...
            поколением. Дарвин не знал ДНК и генов, но верно увидел общий принцип: виды имеют историю, родство и
            меняются под действием наследственной изменчивости и отбора. Современная теория эволюции шире Дарвина: к
            отбору добавились генетика, ДНК, палеонтология и статистические модели родства.
          </p>
        </div>
      </article>
